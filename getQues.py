...
browser = webdriver.Chrome(dir + '/chromedriver', options=options)
...
for ques_num in quesList:
	...
	for link in question_soup.findAll('span', attrs={'class': re.compile("btn-content__10Tj")}):
	...
	with open('md/' + ques_file_name + '.md', 'r+') as f:
		...
		f.write('{% elsif page.level == "Medium" %}\n')
